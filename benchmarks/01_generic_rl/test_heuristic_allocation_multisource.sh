...
TRAIN_ROOT=${TRAIN_ROOT:-outputs/benchmarks/generic_rl/heuristic_allocation}
BUFFER_ROOT=${BUFFER_ROOT:-data/multisource_ready_22-25/08_replay_buffer}
TEST_ROOT=${TEST_ROOT:-outputs/benchmarks/generic_rl/heuristic_allocation_test}
...
REGIME_SPLIT=0 \
ZERO_MARKET_FACTORS=1 \
MARKET_FACTOR_DIM="$MARKET_FACTOR_DIM" \
MAX_JOBS="$MAX_JOBS" \
RUN_TAG="$RUN_TAG" \
