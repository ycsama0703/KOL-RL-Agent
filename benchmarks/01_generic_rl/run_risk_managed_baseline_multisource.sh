...
OUTPUT_ROOT=${OUTPUT_ROOT:-outputs/benchmarks/generic_rl/risk_managed_baseline}
BC_BATCH_SIZE=${BC_BATCH_SIZE:-256}
BC_EPOCHS=${BC_EPOCHS:-10}
ENTRY_THRESHOLD=${ENTRY_THRESHOLD:-0.01}
CLAMP_DELTA=${CLAMP_DELTA:-0.6}
...
for task in "${TASKS[@]}"; do
  ...
  echo "Launch Risk-Managed Baseline for $rel -> $log_file"
