...
BUFFER_ROOT=${BUFFER_ROOT:-ablation_study/01_behavior/buffers/baseline}
...
OUTPUT_DIR=${OUTPUT_DIR:-outputs/ablation/behavior_baseline}
TEST_DIR=${TEST_DIR:-outputs/ablation/behavior_baseline_test}
DEVICE=${DEVICE:-cpu}
